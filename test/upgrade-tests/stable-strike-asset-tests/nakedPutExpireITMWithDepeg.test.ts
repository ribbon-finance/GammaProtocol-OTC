...
contract('Naked Put Option with USDC collateral and stable strike asset expires Itm flow with depeg', ([accountOwner1, buyer]) => {
  let expiry: number
  ...
  describe('Integration test: Close a naked put after it expires ITM with depeg', () => {
